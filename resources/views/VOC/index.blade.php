...
<body class="overflow-x-hidden bg-black h-full">
    ...
    <div id="mainGS" class="flex flex-col justify-center items-center my-24">
        <img class="hidden md:block h-36 px-2" src="/images/voc.webp" alt="" />
        <img class="md:hidden w-5/6" src="/images/vocHP.webp" alt="">
    </div>
                            ...
                            <div class="mx-auto flex flex-wrap content-center mb-12 md:mb-0">
                                <div class="flex space-x-4 mt-4 sm:mt-0">
                                    ...
                                    <a href="https://instagram.com/umnradioactive" target="_blank"
                                        class="text-white">
                                        <<<<<<< HEAD <svg class="h-12 w-12 fill-current"
