...
<body class="overflow-x-hidden bg-black h-full">
    ...
    <div id="header" x-data="{ isOpen: false }" class="fixed navbar bg-[#0E0EC0] justify-center gap-16 z-40 transition-all duration-700">
        ...
        <div class="pt-16">
            <img class="w-full h-48 md:h-80 object-cover" src="/images/FOTO CLOSING NIGHT.webp"
            alt="" />
        </div>
                    ...
                    <div id="ticket1" class="w-72 relative" data-aos="fade-up">
                        ...
                        <div class="absolute top-0 bottom-0 left-0 right-0">
                            ...
                            <div id="buttonearly1" class="flex justify-center items-center mt-32">
                                <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="bg-black text-white border-white py-4 px-6 font-taruno font-bold border-2 inline-flex items-center focus:ring-gray-300" type="button">BUY NOW <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                                </svg></button>
                                <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                                    <li>
                                        <a href="#a" class="block font-pathway px-4 py-2 hover:bg-gray-100 no-underline hover:underline hover:underline-offset-4 hover:decoration-[#FFF000]">Single</a>
                                    </li>
                                    <li>
                                        <a href="#b" class="block font-pathway px-4 py-2 hover:bg-gray-100 no-underline hover:underline hover:underline-offset-4 hover:decoration-[#FFF000]">Bundle</a>
                                    </li>
                                    </ul>
                                </div>
                            </div>
                            <div id="buttonearly2" class="hidden flex justify-center items-center mt-32">
                                <button class="disable bg-slate-400 text-white border-white py-4 px-6 font-taruno font-bold border-2 cursor-not-allowed inline-flex items-center focus:ring-gray-300" type="button">SOLD OUT <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                                </svg></button>
                            </div>
                        </div>
                    ...
                    <div id="ticket2" class="w-72 relative" data-aos="fade-up">
                        ...
                        <div class="absolute top-0 bottom-0 left-0 right-0">
                            ...
                            <div id="buttonpresale1" class="flex justify-center items-center mt-32">
                                <button class="disable bg-slate-400 text-white border-white py-4 px-6 font-taruno font-bold border-2 cursor-not-allowed inline-flex items-center focus:ring-gray-300" type="button">BUY NOW <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                                </svg></button>
                            </div>
                            <div id="buttonpresale2" class="hidden flex justify-center items-center mt-32">
                                <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown2" class="bg-black text-white border-white py-4 px-6 font-taruno font-bold border-2 inline-flex items-center focus:ring-gray-300" type="button">BUY NOW <svg class="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                                </svg></button>
                                <div id="dropdown2" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                                    <li>
                                        <a href="#c" class="block font-pathway px-4 py-2 hover:bg-gray-100 no-underline hover:underline hover:underline-offset-4 hover:decoration-[#FFF000]">Single</a>
                                    </li>
                                    <li>
                                        <a href="#d" class="block font-pathway px-4 py-2 hover:bg-gray-100 no-underline hover:underline hover:underline-offset-4 hover:decoration-[#FFF000]">Bundle</a>
                                    </li>
                                    </ul>
                                </div>
                            </div>
