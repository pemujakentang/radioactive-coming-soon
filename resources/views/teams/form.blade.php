...
<body class="antialiased">
    @if ($amount == 1)
        <form action="/teams" class="" enctype="multipart/form-data"
            method="post">
            <div class="w-full max-w-xs bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div class="mb-0.5">
                    <div>
                        <label class="block text-gray-700 text-sm font-bold mb-0.5" for="">Institusi
                            Asal</label>
                    </div>
                    <div>
                        <input
                    ...
                    <div class="mb-0.5">
                        ...
                        <div>
                            <input
                                ...
                                type="text" placeholder="Institusi Asal" name="tim2_institusi"
